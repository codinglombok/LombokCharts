...
export class Tooltip {
  constructor(container, theme) {
    ...
    Object.assign(this.el.style, {
      position: 'absolute', pointerEvents: 'none', zIndex: '20', opacity: '0',
      transition: 'opacity .12s', padding: '6px 9px', borderRadius: '6px',
      font: `${theme.typography.labelSize}px ${theme.typography.family}`,
      maxWidth: '240px', transform: 'translate(-50%, calc(-100% - 10px))', whiteSpace: 'nowrap',
    });
    this._applyTheme();

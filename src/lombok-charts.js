...
export function chart(el, config) { return new Chart(el, config); }
...
export { RadarMark, HeatmapMark, BoxPlotMark, HistogramMark, CandlestickMark, FunnelMark, TreemapMark, SankeyMark };
